...
var EnrollDTO = function (tam_name, site_info, tam_local_ip,
		tam_local_port, tam_adm_port,tam_pub_ip,tam_pub_port,tam_pub_adm_port,
	...
	this.tam_adm_port = tam_adm_port;
	this.tam_pub_ip = tam_pub_ip;
	this.tam_pub_port = tam_pub_port;
	this.tam_pub_adm_port = tam_pub_adm_port;
...
var UpdateDTO = function (tam_no, tam_name, site_info, tam_local_ip,
		tam_local_port, tam_adm_port,tam_pub_ip,tam_pub_port,tam_pub_adm_port, tam_license, shared_path,  comm_type, watchdog, exist) {
...
var IntegrityDTO = function (tam_name, tam_local_ip, tam_local_port, tam_adm_port, tam_license) {
